...
class T1 extends Table
  ...
  static const VerificationMeta _insertDateMeta = const VerificationMeta(
    'insertDate',
  );
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('insert_date')) {
      context.handle(
        _insertDateMeta,
        insertDate.isAcceptableOrUnknown(data['insert_date']!, _insertDateMeta),
      );
    } else if (isInserting) {
  ...
  T1Data map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return T1Data(
      ...
      insertDate: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}insert_date'],
      )!,
    );
  }
...
class T1Data extends DataClass implements Insertable<T1Data> {
  ...
  T1Data copyWithCompanion(T1Companion data) {
    return T1Data(
      ...
      insertDate: data.insertDate.present
          ? data.insertDate.value
          : this.insertDate,
    );
  }
...
typedef $T1CreateCompanionBuilder =
    T1Companion Function({
      required String title,
      required String content,
      required String insertDate,
      Value<int> rowid,
    });
typedef $T1UpdateCompanionBuilder =
    T1Companion Function({
      Value<String> title,
      Value<String> content,
      Value<String> insertDate,
...
typedef $T1ProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$MainTableCreateCompanionBuilder =
    MainCompanion Function({
      Value<int> id,
      required String title,
      required String content,
      required DateTime insertDate,
    });
typedef $$MainTableUpdateCompanionBuilder =
    MainCompanion Function({
      Value<int> id,
      Value<String> title,
      Value<String> content,
...
typedef $$MainTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $MainTable,
      MainData,
