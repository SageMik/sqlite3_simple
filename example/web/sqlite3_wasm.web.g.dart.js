...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    DatabaseImplementation: function DatabaseImplementation(t0, t1) {
      this.bindings = t0;
      this.database = t1;
    },
    ...
    DefaultSimpleWasmModuleLoader_create(files) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.DefaultSimpleWasmModuleLoader),
        $async$returnValue;
      var $async$DefaultSimpleWasmModuleLoader_create = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$returnValue = new A.DefaultSimpleWasmModuleLoader(new A.DefaultSimpleBridgeCallbacks(new A.WASI(A._createDelegate(B.List_empty0, B.Map_empty0, files, B.Map_kdX6R, true, 2, 0, 1, B.WASIVersion_0))), new A.DartBridgeCallbacks(A.LinkedHashMap_LinkedHashMap$_empty(type$.int, type$.AggregateContext_nullable_Object)));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$DefaultSimpleWasmModuleLoader_create, $async$completer);
    },
    ...
    Sqlite3Dao__toMainTableRows_closure: function Sqlite3Dao__toMainTableRows_closure(t0, t1) {
      this.$this = t0;
      this.resultSet = t1;
    },
    Sqlite3Wasm__fetch(url) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Uint8List),
        $async$returnValue, t1, $async$temp1, $async$temp2;
      var $async$Sqlite3Wasm__fetch = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = A;
              $async$goto = 4;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(t1.fetch(A._asJSObject(new t1.URL(url, A.Uri_base().toString$0(0))))), type$.JSObject), $async$Sqlite3Wasm__fetch);
            case 4:
              // returning from await.
              $async$goto = 3;
              return A._asyncAwait($async$temp1.promiseToFuture($async$temp2._asJSObject($async$result.bytes()), type$.NativeUint8List), $async$Sqlite3Wasm__fetch);
            case 3:
              // returning from await.
      ...
      return A._asyncStartSync($async$Sqlite3Wasm__fetch, $async$completer);
    },
    ...
    _$Sqlite3Wasm$WorkerService: function _$Sqlite3Wasm$WorkerService(t0) {
      this.__Sqlite3Wasm__wasmSqlite3_A = this.__Sqlite3Wasm__dao_F = $;
      this._inMemoryFileSystem = t0;
    },
    ...
    _$Ser: function _$Ser(t0) {
      this.___$Ser_$1_FI = this.___$Ser_$0_FI = $;
      this._converter = t0;
    },
    ...
    _createDelegate(args, env, files, preopens, returnOnExit, stderr, stdin, stdout, version) {
      ...
      return A.WASI$(args, env, files, preopens, true, stderr, stdin, stdout, version);
    },
    WASI: function WASI(t0) {
      this._delegate = t0;
    },
    WASI$(args, env, files, preopens, returnOnExit, stderr, stdin, stdout, version) {
      ...
      for (t9 = new A.LinkedHashMapEntriesIterable(files, A._instanceType(files)._eval$1("LinkedHashMapEntriesIterable<1,2>")).get$iterator(0); t9.moveNext$0();) {
        entry = t9.__js_helper$_current;
        t6.$indexSet(0, A._normalizeGuestPath(entry.key), entry.value);
      }
  ...
  A.DatabaseImplementation.prototype = {
    execute$1(sql) {
      ...
      if (J.get$length$asx(parameters) === 0) {
        ...
        if (t1 !== 0)
          A.throwException(this, t1, "executing", sql, parameters);
      } else {
    ...
    _prepareInternal$5$checkNoTail$maxStatements$persistent$vtab(sql, checkNoTail, maxStatements, persistent, vtab) {
      var t2, ptr, t3, t4, compiler, createdStatements, freeIntermediateResults, offset, result, t5, $length, t6, endOffset, stmt, _this = this,
  ...
  A.WasmDatabase.prototype = {$isRawSqliteDatabase: 1};
  ...
  A.DefaultSimpleWasmModuleLoader.prototype = {
    ...
    instantiateModule$1(response) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.JSObject),
        $async$returnValue, $async$self = this, source, memory;
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$self._callbacks._wasi._delegate.finalizeBindings$2$memory($.$get$_EmptyInstance_instance(), new A._MemoryFromJsToWasd(memory));
  ...
  A.DefaultSimpleWasmModuleLoader_createImportObject_closure.prototype = {
    call$0() {
      var result,
        _dartInstance = this.$this._callbacks,
        t1 = A._asJSObject(init.G.Object),
        _jsExporter = A._asJSObject(t1.create.apply(t1, [null]));
      _jsExporter.environ_get = A._functionToJS2(_dartInstance.get$environ_get());
      _jsExporter.environ_sizes_get = A._functionToJS2(_dartInstance.get$environ_sizes_get());
      _jsExporter.clock_time_get = A._functionToJS3(_dartInstance.get$clock_time_get());
      _jsExporter.fd_close = A._functionToJS1(_dartInstance.get$fd_close());
      _jsExporter.fd_fdstat_get = A._functionToJS2(_dartInstance.get$fd_fdstat_get());
      _jsExporter.fd_fdstat_set_flags = A._functionToJS2(_dartInstance.get$fd_fdstat_set_flags());
      _jsExporter.fd_prestat_get = A._functionToJS2(_dartInstance.get$fd_prestat_get());
      _jsExporter.fd_prestat_dir_name = A._functionToJS3(_dartInstance.get$fd_prestat_dir_name());
      _jsExporter.fd_read = A._functionToJS4(_dartInstance.get$fd_read());
      _jsExporter.fd_seek = A._functionToJS4(_dartInstance.get$fd_seek());
      _jsExporter.fd_write = A._functionToJS4(_dartInstance.get$fd_write());
      t1 = _dartInstance.get$path_open();
      ...
      }(A._callDartFunctionFastN, t1, 9);
      result[$.$get$DART_CLOSURE_PROPERTY_NAME()] = t1;
      _jsExporter.path_open = result;
      _jsExporter.proc_exit = A._functionToJS1(_dartInstance.get$proc_exit());
      return _jsExporter;
    },
    $signature: 24
  };
  A.Sqlite3Dao.prototype = {
    initFts5$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t1;
      var $async$initFts5$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.db;
              t1.execute$1("      CREATE TABLE custom (\n        id INTEGER PRIMARY KEY AUTOINCREMENT, \n        title TEXT, \n        content TEXT, \n        insert_date INTEGER\n      );\n    ");
              t1.execute$1("      CREATE VIRTUAL TABLE t1 USING fts5(\n        title, content, insert_date UNINDEXED, \n        tokenize = 'simple', \n        content = 'custom', \n        content_rowid = 'id'\n      );\n    ");
              t1.execute$1("      CREATE TRIGGER custom_insert AFTER INSERT ON custom BEGIN \n              INSERT INTO t1(rowid, title, content, insert_date) \n        VALUES (new.id, new.title, new.content, new.insert_date);\n    \n      END;\n    ");
              t1.execute$1("      CREATE TRIGGER custom_delete AFTER DELETE ON custom BEGIN \n              INSERT INTO t1(t1, rowid, title, content, insert_date) \n        VALUES ('delete', old.id, old.title, old.content, old.insert_date);\n    \n      END;\n    ");
              t1.execute$1("      CREATE TRIGGER custom_update AFTER UPDATE ON custom BEGIN \n              INSERT INTO t1(t1, rowid, title, content, insert_date) \n        VALUES ('delete', old.id, old.title, old.content, old.insert_date);\n    \n              INSERT INTO t1(rowid, title, content, insert_date) \n        VALUES (new.id, new.title, new.content, new.insert_date);\n    \n      END;\n    ");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$initFts5$0, $async$completer);
    },
    insertRandomData$1($length) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t1, t2, i, newRow, t3, t4, insertStmt;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              for (t1 = insertStmt.statement, t2 = t1.stmt, t1 = t1.bindings.sqlite3, i = 0; i < $length; ++i) {
                newRow = A.createRandomRow(i);
                t3 = newRow.insertDate;
                t4 = insertStmt._closed;
                if (t4)
                  A.throwExpression(A.StateError$(string$.Tried_));
                if (!insertStmt._inResetState) {
                  A._asInt(t1.sqlite3_reset(t2));
                  insertStmt._inResetState = true;
                }
                insertStmt._bindParams$1(new A.IndexedParameters([null, newRow.title, newRow.content, 1000 * t3._core$_value + t3._microsecond]));
    ...
    _toMainTableRows$1(resultSet) {
      return A.List_List$generate(resultSet.rows.length, new A.Sqlite3Dao__toMainTableRows_closure(this, resultSet), type$.MainTableRow);
    },
    selectAll$0() {
      var $async$goto = 0,
    ...
    updateAll$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t1, t2, t3, i, oldRow, newRow, t4, t5, mainTableRowList, updateStmt;
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 2:
              ...
              for (t1 = J.getInterceptor$asx(mainTableRowList), t2 = updateStmt.statement, t3 = t2.stmt, t2 = t2.bindings.sqlite3, i = 0; i < t1.get$length(mainTableRowList); ++i) {
                oldRow = t1.$index(mainTableRowList, i);
                newRow = A.createRandomRow(i);
                t4 = newRow.insertDate;
                t5 = updateStmt._closed;
                if (t5)
                  A.throwExpression(A.StateError$(string$.Tried_));
                ...
                updateStmt._bindParams$1(new A.IndexedParameters([newRow.title, newRow.content, 1000 * t4._core$_value + t4._microsecond, oldRow.id]));
  ...
  A.Sqlite3Wasm.prototype = {
    ...
    initDatabase$body$Sqlite3Wasm(jiebaDictPath2Url) {
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$temp3 = t1;
              $async$goto = 6;
              return A._asyncAwait(A.DefaultSimpleWasmModuleLoader_create(t2), $async$initDatabase$1);
            case 6:
              // returning from await.
              $async$goto = 5;
              return A._asyncAwait($async$temp2.WasmSqlite3_loadFromUrl($async$temp3, $async$result), $async$initDatabase$1);
            case 5:
              // returning from await.
              t1 = $async$temp1._as($async$result);
              $async$self.__Sqlite3Wasm__wasmSqlite3_A = t1;
              _this = $async$self._inMemoryFileSystem;
              t1.initialize$0();
              t1 = t1.bindings.bindings;
      ...
      return A._asyncStartSync($async$initDatabase$1, $async$completer);
    },
    closeDatabase$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t2, t3, ptr, t1;
      var $async$closeDatabase$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
      ...
      return A._asyncStartSync($async$closeDatabase$0, $async$completer);
    }
  };
  A._extension_0__$getOperations_closure.prototype = {
    call$1($$req) {
      return this._this.closeDatabase$0();
    },
    $signature: 7
  };
  ...
  A.LazyInPlaceMap.prototype = {
    get$entries() {
      var t1 = this.$ti,
        t2 = J.cast$1$0$ax(this._lazy_in_place_map$_data.get$keys(), t1._precomputed1);
    ...
    get$keys() {
      return J.cast$1$0$ax(this._lazy_in_place_map$_data.get$keys(), this.$ti._precomputed1);
    },
    get$length(_) {
      var t1 = this._lazy_in_place_map$_data;
      return t1.get$length(t1);
    ...
    forEach$1(_, action) {
      var t2, t3, k, t4,
        t1 = this.$ti;
      t1._eval$1("~(1,2)")._as(action);
      for (t2 = J.get$iterator$ax(this._lazy_in_place_map$_data.get$keys()), t3 = t1._precomputed1, t1 = t1._rest[1]; t2.moveNext$0();) {
        k = t2.get$current();
        t3._as(k);
    ...
    map$2$1(_, convert, $K2, $V2) {
      ...
      keys = J.toList$0$ax(this._lazy_in_place_map$_data.get$keys());
  ...
  (function installTearOffs() {
    ...
    _instance_2_u(_, "get$xTruncate", "xTruncate$2", 34);
    _instance_2_u(_, "get$xSync", "xSync$2", 6);
    _instance_2_u(_, "get$xFileSize", "xFileSize$2", 6);
    _instance_2_u(_, "get$xLock", "xLock$2", 6);
    _instance_2_u(_, "get$xUnlock", "xUnlock$2", 6);
    _instance_2_u(_, "get$xCheckReservedLock", "xCheckReservedLock$2", 6);
    _instance_1_u(_, "get$xDeviceCharacteristics", "xDeviceCharacteristics$1", 21);
    _instance_1_u(_, "get$dispatchVoid", "dispatchVoid$1", 8);
    _instance_1_u(_, "get$dispatchInt", "dispatchInt$1", 37);
    _instance(_, "get$dispatchUpdateHook", 0, 5, null, ["call$5"], ["dispatchUpdateHook$5"], 38, 0, 0);
    ...
    _instance(_, "get$dispatchXCompare", 0, 5, null, ["call$5"], ["dispatchXCompare$5"], 41, 0, 0);
    _instance_2_u(_, "get$dispatchBusyHandler", "dispatchBusyHandler$2", 42);
    _instance_2_u(_, "get$dispatchApplyFilter", "dispatchApplyFilter$2", 43);
    _instance(_, "get$dispatchApplyConflict", 0, 3, null, ["call$3"], ["dispatchApplyConflict$3"], 44, 0, 0);
    ...
    _instance(_, "get$clock_time_get", 0, 3, null, ["call$3"], ["clock_time_get$3"], 46, 0, 0);
    ...
    _instance(_, "get$fd_prestat_dir_name", 0, 3, null, ["call$3"], ["fd_prestat_dir_name$3"], 47, 0, 0);
    _instance(_, "get$fd_read", 0, 4, null, ["call$4"], ["fd_read$4"], 25, 0, 0);
    _instance(_, "get$fd_seek", 0, 4, null, ["call$4"], ["fd_seek$4"], 49, 0, 0);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      DefaultSimpleWasmModuleLoader: findType("DefaultSimpleWasmModuleLoader"),
